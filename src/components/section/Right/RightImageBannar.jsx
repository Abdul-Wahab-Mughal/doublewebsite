...
export default function RightImageBannar() {
  return (
    <section className="relative h-screen flex justify-center items-center">
      ...
      {/* Text */}
      <div className=" flex max-md:flex-wrap justify-evenly items-center m-auto w-full z-10">
        <div className="text-2xl md:text-4xl max-w-125 font-semibold">
          Where style meets comfort & every piece tells a story
        </div>
        <div className="">
          <div className="text-4xl md:text-6xl uppercase">50% off </div>
