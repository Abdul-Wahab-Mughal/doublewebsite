  ...
  return (
    <>
      <section ref={refcard}>
        ...
        >
          <SwiperSlide className=" text-black space-y-2.5 cursor-pointer">
                  ...
                  <div className="lg:pb-[150%] relative rounded-[100px] md:rounded-full overflow-hidden group">
                    <Link to="/y/collection">
                      <img
                        src={card}
                        alt=""
                        className="max-lg:aspect-square lg:absolute h-full w-full group-hover:scale-105 duration-500"
                      />
                    </Link>
                  ...
                  <div className=" relative rounded-bl-[50px] md:rounded-bl-[125px] rounded-tr-[50px] md:rounded-tr-[125px] overflow-hidden lg:rounded-none group">
                    <Link to="/y/collection">
                      <img
                        ...
                        alt=""
                        className=" lg:aspect-square w-full aspect-square group-hover:scale-105 duration-500"
                      />
                    </Link>
                    <EyeView />
                  </div>
                  ...
                  <div className="lg:pb-[150%] relative rounded-[100px] md:rounded-full group overflow-hidden">
                    <Link to="/y/collection">
                      <img
                        ...
                        alt=""
                        className="lg:absolute h-full w-full max-lg:aspect-square group-hover:scale-105 duration-500"
                      />
                    </Link>
                    <EyeView className=" bottom-0 right-16" />
                  </div>
